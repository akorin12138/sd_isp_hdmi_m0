 ...
 ** File	:	E:/project/AnlogicFPGA/EG4S20/sd_isp_hdmi/td56/al_ip/tempfifo.v
 ** Date	:	2024 05 08
 ** TD version	:	5.6.88061
\************************************************************/
module tempfifo #(parameter DATA_WIDTH_W = 24, 
    ...
    fifo_cross_domain_addr_process_al_tempfifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_tempfifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_tempfifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module fifo_cross_domain_addr_process_al_tempfifo #(parameter ADDR_WIDTH = 9) (
...
`timescale 1ns/1ps
module ram_infer_tempfifo (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
