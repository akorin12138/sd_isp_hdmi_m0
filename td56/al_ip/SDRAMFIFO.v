 ...
 ** File	:	E:/Documents/2024/sd_isp_hdmi/td56/al_ip/SDRAMFIFO.v
 ** Date	:	2024 04 05
...
module SDRAMFIFO #(parameter DATA_WIDTH_W = 16, 
    ...
    fifo_cross_domain_addr_process_al_SDRAMFIFO #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_SDRAMFIFO #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_SDRAMFIFO #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_SDRAMFIFO #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_SDRAMFIFO (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
    ...
    reg [(MIN_WIDTH - 1):0] memory [(MAX_DEPTH - 1):0] ;  /* fehdl force_ram=1, ram_style="bram_9k_fast" */ 
