...
set rc [catch {
  route
  report_area -io_info -file sd_isp_hdmi_phy.area
  export_db {sd_isp_hdmi_pr.db}
  start_timer
  report_timing -mode FINAL -net_info  -rpt_autogen true -file sd_isp_hdmi_phy.timing
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid sd_isp_hdmi_inst.bid
  bitgen -bit "sd_isp_hdmi.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
